    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navbar class="-mb-px max-lg:hidden">
                ...
                <flux:navbar.item icon="bolt" :href="route('workouts')" :current="request()->routeIs('workouts')" wire:navigate>
                    {{ __('Workouts') }}
                </flux:navbar.item>
                <flux:navbar.item icon="clipboard" :href="route('manual-logs')" :current="request()->routeIs('manual-logs')" wire:navigate>
                    {{ __('Manual Logs') }}
                </flux:navbar.item>
